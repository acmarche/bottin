...
class SituationController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render(
            '@AcMarcheBottin/situation/index.html.twig',
            [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render(
            '@AcMarcheBottin/situation/new.html.twig',
            [
                'entity' => $situation,
    ...
    public function show(Situation $situation): Response
    {
        ...
        return $this->render(
            '@AcMarcheBottin/situation/show.html.twig',
            [
                'situation' => $situation,
                'fiches' => $fiches,
            ]
    ...
    public function edit(Situation $situation, Request $request): Response
    {
        ...
        return $this->render(
            '@AcMarcheBottin/situation/edit.html.twig',
            [
                'situation' => $situation,
